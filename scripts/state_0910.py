"""State read for the 2026-09-10 02:05 overnight run. Read-only.

Same shape as state_0908.py. Queue A's SupplierPart pool was closed 2026-09-01
and queue B on 09-06, so what matters is the DELTA (parts created since closure,
